...
const KEY_STYLE = 'w-[60px] h-[50px] border border-black/15 rounded text-black text-2xl active:text-white active:bg-rose-500';
      ...
      <div className="flex gap-4">
        <div className="flex flex-col gap-1">
          ...
          <div className="flex gap-1.5">
            ...
            <button type="button" className="rounded active:text-white border border-black/15 active:bg-rose-500 w-[258px] h-[50px]" onClick={() => sendKey(' ')} aria-label="Space" />
