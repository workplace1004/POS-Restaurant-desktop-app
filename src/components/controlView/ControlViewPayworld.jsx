...
export function ControlViewPayworld({
  ...
  return (
    <div className="relative pb-8 pt-4">
      <div className="flex text-lg gap-x-10 gap-y-4 mb-6">
        <div className="flex flex-col gap-4 pt-[100px] w-full justify-center items-center">
          <div className="flex items-center gap-2">
            <label className="block text-black font-medium min-w-[100px] max-w-[100px] shrink-0">{tr('control.payworld.name', 'Name *')}</label>
            <input
              type="text"
              value={payworldName}
          ...
          <div className="flex items-center gap-2">
            <label className="block text-black font-medium min-w-[100px] max-w-[100px] shrink-0">{tr('control.payworld.ipAddress', 'IP address *')}</label>
            <input
              type="text"
          ...
          <div className="flex items-center gap-2">
            <label className="block text-black font-medium min-w-[100px] max-w-[100px] shrink-0">{tr('control.payworld.port', 'Port *')}</label>
            <input
              type="text"
              value={payworldPort}
      ...
      <div className="flex justify-center pt-5 pb-5">
        <button type="button" className="flex items-center text-lg gap-4 px-[70px] py-3 rounded-lg bg-rose-600 text-white font-medium active:bg-rose-500 disabled:opacity-50" disabled={savingPayworld} onClick={handleSavePayworld}>
      ...
      <div className="shrink-0 absolute w-full flex justify-center">
