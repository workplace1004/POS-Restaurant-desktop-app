              ...
              {sortedCategories.map((cat, index) => (
                ...
                >
                  <div className="flex items-center gap-2 shrink-0">
                    <button
                      type="button"
                      className="p-2 rounded text-black active:text-rose-500 disabled:opacity-30 disabled:cursor-not-allowed"
                    ...
                    <button
                      ...
                      aria-label="Move up"
                    >
                      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 10l7-7m0 0l7 7m-7-7v14" /></svg>
                    </button>
                  </div>
