                ...
                <div className="grid grid-cols-1 text-sm md:grid-cols-2 gap-x-10 gap-y-4">
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <Dropdown options={mapTranslatedOptions(vatOptions)} value={deviceCounterSaleVat} onChange={setDeviceCounterSaleVat} placeholder={tr('control.external.select', 'Select')} className="text-sm min-w-[150px]" />
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-pos-text min-w-[270px] max-w-[270px] shrink-0">{tr('control.device.general.tableSaleVat', 'Table sale VAT:')}</span>
                      <Dropdown options={mapTranslatedOptions(vatOptions)} value={deviceTableSaleVat} onChange={setDeviceTableSaleVat} placeholder={tr('control.external.select', 'Select')} className="text-sm min-w-[150px]" />
                    </div>
                    <div className="flex items-center gap-3">
                ...
                <div className="grid grid-cols-1 text-sm md:grid-cols-2 gap-x-10 gap-y-4">
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <Dropdown options={mapTranslatedOptions(printingOrderOptions)} value={devicePrinterNextCourseOrder} onChange={setDevicePrinterNextCourseOrder} placeholder={tr('control.external.asRegistered', 'As Registered')} className="text-sm min-w-[150px] max-w-[150px]" />
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <Dropdown options={mapTranslatedOptions(groupingReceiptOptions)} value={devicePrinterStandardMode} onChange={setDevicePrinterStandardMode} placeholder={tr('control.external.enable', 'Enable')} className="text-sm min-w-[150px] max-w-[150px]" />
                    </div>
                    <div className="flex items-center gap-3">
